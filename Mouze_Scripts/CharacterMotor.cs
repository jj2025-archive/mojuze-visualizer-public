...
public class CharacterMotor : MonoBehaviour
{
	[Serializable]
	[CompilerGenerated]
	internal sealed class _0024SubtractNewPlatformVelocity_002488 : GenericGenerator<object>
	{
		[Serializable]
		[CompilerGenerated]
		internal sealed class _0024 : GenericGeneratorEnumerator<object>, IEnumerator
		{
			internal Transform _0024platform_002489;

			internal CharacterMotor _0024self__002490;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (_0024self__002490.movingPlatform.enabled && (_0024self__002490.movingPlatform.movementTransfer == MovementTransferOnJump.InitTransfer || _0024self__002490.movingPlatform.movementTransfer == MovementTransferOnJump.PermaTransfer))
					{
						if (_0024self__002490.movingPlatform.newPlatform)
						{
							_0024platform_002489 = _0024self__002490.movingPlatform.activePlatform;
				...
				case 2:
					...
					break;
				case 3:
					if (_0024self__002490.grounded && _0024platform_002489 == _0024self__002490.movingPlatform.activePlatform)
					{
					...
					goto case 4;
				case 4:
					_0024self__002490.movement.velocity = _0024self__002490.movement.velocity - _0024self__002490.movingPlatform.platformVelocity;
					goto IL_0124;
				case 1:
					{
						result = 0;
		...
		internal CharacterMotor _0024self__002491;

		public _0024SubtractNewPlatformVelocity_002488(CharacterMotor self_)
		{
			_0024self__002491 = self_;
		}

		public override IEnumerator<object> GetEnumerator()
		{
			return new _0024(_0024self__002491);
		}
	}
	...
	{
		return new _0024SubtractNewPlatformVelocity_002488(this).GetEnumerator();
	}
